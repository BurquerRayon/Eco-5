...
const DatosPersonales = () => {
    ...
    const loadData = async () => {
      try {
        ...
        const [userData, nacionalidades] = await Promise.all([
          axios.get(`http://ecomaravilla2.duckdns.org:3001/api/cliente/datos/${user.id_usuario}`),
          axios.get('http://ecomaravilla2.duckdns.org:3001/api/cliente/nacionalidades')
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://ecomaravilla2.duckdns.org:3001/api/cliente/datos/${user.id_usuario}`,
        formData
      );
