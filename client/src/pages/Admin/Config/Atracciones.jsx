...
const AtraccionesConfig = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editandoId) {
        await axios.put(`http://ecomaravilla2.duckdns.org:3001/api/atracciones/${editandoId}`, form);
        setMensaje('Atracción actualizada correctamente');
      } else {
        await axios.post('http://ecomaravilla2.duckdns.org:3001/api/atracciones', form);
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete(`http://ecomaravilla2.duckdns.org:3001/api/atracciones/${id}`);
