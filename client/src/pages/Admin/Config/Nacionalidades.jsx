...
const NacionalidadesConfig = () => {
  ...
  const fetchNacionalidades = async () => {
    try {
      const res = await axios.get('http://ecomaravilla2.duckdns.org:3001/api/nacionalidades');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editandoId) {
        await axios.put(`http://ecomaravilla2.duckdns.org:3001/api/nacionalidades/${editandoId}`, form);
        setMensaje('✅ Nacionalidad actualizada');
      } else {
        await axios.post('http://ecomaravilla2.duckdns.org:3001/api/nacionalidades', form);
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete(`http://ecomaravilla2.duckdns.org:3001/api/nacionalidades/${id}`);
