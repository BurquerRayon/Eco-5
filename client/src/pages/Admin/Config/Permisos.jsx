...
const PermisosConfig = () => {
  ...
  const fetchPermisos = async () => {
    try {
      const res = await axios.get('http://ecomaravilla2.duckdns.org:3001/api/permisos');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editandoId) {
        await axios.put(`http://ecomaravilla2.duckdns.org:3001/api/permisos/${editandoId}`, form);
        setMensaje('✅ Permiso actualizado');
      } else {
        await axios.post('http://ecomaravilla2.duckdns.org:3001/api/permisos', form);
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete(`http://ecomaravilla2.duckdns.org:3001/api/permisos/${id}`);
